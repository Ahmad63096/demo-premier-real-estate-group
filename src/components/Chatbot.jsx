        ...
        <div className="chat enter">
          {isChatTab ? (
            <div className="header">
              ...
              <span className="title" >Premier Real Estate Group</span>
          ...
          {!isChatTab ? (
            <>
              <ul className="messages-two">
                ...
                <a href="https://www.premierreig.com/" target="_blank" rel="noopener noreferrer">
                  <li>
                    🎓 Services
                    <Services />
                  </li>
                </a>
                <a href="https://www.premierreig.com/our-company/" target="_blank" rel="noopener noreferrer">
                  <li>
                    🎉 Resources
                    <Resources />
                  </li>
                </a>
                <a href="https://www.premierreig.com/contact-us/" target="_blank" rel="noopener noreferrer">
                  <li>
                    💬 Contact us
                    <Contact />
                  </li>
