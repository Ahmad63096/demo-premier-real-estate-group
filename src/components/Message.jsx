...
function Message() {
  ...
  const handleButtonClick = (buttonText) => {
    ...
    const buttonResponses = {
      ...
      "Find Rental Deals": "I want to know about Find Rental Deals."
    };
  ...
  useEffect(() => {
    const fetchGreetingMessage = async () => {
      try {
        const data = "Hey there! I’m your virtual assistant at Premier Real Estate Group. How are you today?😊";
